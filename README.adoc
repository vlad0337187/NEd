...
https://www.gtk.org/[GTK] is not very popular currently -- mailing lists and IRC have very low
...
Optionally you may use Nim's package manager nimble to locally install the
...
The title bar of the _Gnome Desktop_ should display a _NEd_ menu, which allows
...
indicate that you really want to fill that one.)
